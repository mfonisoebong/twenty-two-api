...
@section('content')
    ...
    <div>
        ...
        <p>
            We regret to inform you that your account on Dex has been temporarily suspended due to unusual
        ...
        <p>
            ...
            can reach us at <a href="mailto:support@dexwearsglobal.com">support@dexwearsglobal.com</a>.
        </p>
        <p>
