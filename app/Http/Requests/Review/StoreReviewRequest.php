...
class StoreReviewRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'width' => ['required', 'in:narrow,fitted,wide'],
            'fit_report' => ['required', 'in:small,fitted,large'],
            'comfort' => ['required', 'in:uncomfortable,comfortable,very_comfortable'],
            'durability' => ['required', 'in:not_durable,durable,very_durable'],
